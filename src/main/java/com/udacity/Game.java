...
public class Game {
    ...
    public String checkGameWinner(char[][] grid) {
        String result = "None";
        String xWinner = "X wins";
        String oWinner = "O wins";
        String tie = "Tie";
        // xWinner
        if (grid[0][0] == 'x') {
        ...
        if (grid[0][0] == 'o') {
            if (grid[0][1] == 'o' && grid[0][2] == 'o') {
                return oWinner;
            }

        }
        if (grid[0][0] == 'o') {
            if (grid[1][0] == 'o' && grid[2][0] == 'o') {
                return oWinner;
            }
        ...
        if (grid[1][0] == 'o') {
            if (grid[1][1] == 'o' && grid[1][2] == 'o') {
                return oWinner;
            }

        }
        if (grid[2][0] == 'o') {
            if (grid[2][1] == 'o' && grid[2][2] == 'o') {
                return oWinner;
            }

        }
        if (grid[0][1] == 'o') {
            if (grid[1][1] == 'o' && grid[2][1] == 'o') {
                return oWinner;
            }

        }
        if (grid[0][2] == 'o') {
            if (grid[1][2] == 'o' && grid[2][2] == 'o') {
                return oWinner;
            }
